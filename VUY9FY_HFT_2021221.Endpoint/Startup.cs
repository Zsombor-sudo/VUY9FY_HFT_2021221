...
namespace VUY9FY_HFT_2021221.Endpoint
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "VUY9FY_HFT_2021221.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "VUY9FY_HFT_2021221.Endpoint v1"));
            }
            ...
            app.UseCors(x => x
                ...
                .AllowAnyMethod()
                .AllowAnyHeader()
                .WithOrigins("http://localhost:52775"));
